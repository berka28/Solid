...
namespace Solid.Models
{
    public class Receipt : IReceipt
    {
        ...
        ISetServicePriceName setServicePriceName = Factory.SetPriceName();
        ...
        {
            setServicePriceName.SetPrices(standardService, wash, clawCutting);
            setServicePriceName.SetName(standardService, wash, clawCutting);
